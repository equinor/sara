...
namespace api.Configurations
{
    public static class AuthenticationConfigurations
    {
        ...
        /// <summary>
        /// The split across both options phases is required: JwtBearerPostConfigureOptions
        /// rejects a plain HTTP authority and runs before any post-configuration we can
        /// register, while Microsoft.Identity.Web installs its AadIssuerValidator during
        /// post-configuration, so only a later post-configure can remove it.
        /// </summary>
