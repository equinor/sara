...
([promoteToProduction](https://github.com/equinor/sara/blob/main/.github/workflows/promoteToProduction.yml)
and [promoteToStaging](https://github.com/equinor/sara/blob/main/.github/workflows/promoteToStaging.yml)).
