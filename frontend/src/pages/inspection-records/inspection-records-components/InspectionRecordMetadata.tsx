...
import type { InspectionRecord, Orientation, Position } from "../../../api/client";
...
interface InspectionRecordMetadataProps {
  record: InspectionRecord;
  navigate: NavigateFunction;
}

export default function InspectionRecordMetadata({ record, navigate }: InspectionRecordMetadataProps) {
